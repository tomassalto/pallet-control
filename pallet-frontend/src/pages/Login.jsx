...
export default function Login() {
  ...
  return (
    <div className="min-h-dvh flex flex-col gap-6 items-center justify-center mt-[-80px] mb-[-40px]">
      <Title size="4xl">Iniciar sesión</Title>
      ...
      >
        ...
        <div className="relative w-full">
          <input
            ...
            className="w-full bg-[#eaeaea] px-3 py-3 pr-10"
          />
          <button
            type="button"
